...
function consultQuickReply(btn) {
  ...
  // 隐藏快捷回复
  document.querySelector('.consult-quick-replies').style.display = 'none';
  // 医生回复
  setTimeout(() => {
    const reply = consultDoctorReplies[text] || '好的，我了解了。我给您继续开处方，请注意按时服药。';
...
function sendConsultMsg() {
  ...
  // 医生通用回复
  setTimeout(() => {
    addConsultMsg('好的，我了解了。根据您的情况，我建议继续当前用药方案。处方我这边开好，您确认后就可以购药了。', 'doctor');
  }, 1200);
}
